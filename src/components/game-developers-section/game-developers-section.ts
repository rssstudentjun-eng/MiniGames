...
export function createGameDevelopersSection(): HTMLElement {
    ...
    gameDevelopersInfoBlockDescription.textContent = 'Want to see your game on MiniGames? We\'re always looking for fun,\n' +
    ...
    gameDevelopersInfoBlock.append(gameDevelopersInfoBlockTitle,
